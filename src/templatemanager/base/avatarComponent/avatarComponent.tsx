...
export function AvatarComponent(props: any) {
    ...
    const [showCardDesign, setShowCardDesign] = useState(true);
const [avatarBgStylee, setAvatarBgStylee] = useState(false);
   ...
   console.log('AvatarComponent brandingInfo: ', brandingInfo);
    setInterval(() => {
 ...
 {showCardDesign ? (
                // Your card design JSX here
               <div className="custom-card">
  <div className="card-header">
    <div className="card-icon">
     <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 8C0 3.58172 3.58172 0 8 0H48C52.4183 0 56 3.58172 56 8V48C56 52.4183 52.4183 56 48 56H8C3.58172 56 0 52.4183 0 48V8Z" fill="url(#paint0_linear_314_25697)"/>
<path d="M27.9995 12C32.243 12 36.3134 13.6859 39.314 16.6865C42.3144 19.6871 43.9995 23.7567 43.9995 28C43.9995 32.2433 42.3144 36.3129 39.314 39.3135C36.3134 42.3141 32.243 44 27.9995 44C23.7562 43.9999 19.6865 42.3139 16.686 39.3135C13.6856 36.3129 11.9995 32.2434 11.9995 28C11.9995 27.356 12.0384 26.7159 12.1147 26.083C12.4668 26.9196 13.2424 27.335 14.0161 27.3291C14.0054 27.5521 13.9995 27.7758 13.9995 28C13.9995 31.7129 15.4747 35.2739 18.1001 37.8994C20.7255 40.5248 24.2866 41.9999 27.9995 42C31.7125 42 35.2744 40.5249 37.8999 37.8994C40.5253 35.2739 41.9995 31.7129 41.9995 28C41.9995 24.2871 40.5253 20.7261 37.8999 18.1006C35.6301 15.8307 32.6605 14.4214 29.4985 14.0811L24.9683 12.4043L24.9282 12.2979C25.9328 12.1013 26.9609 12 27.9995 12ZM15.0806 20.9199L15.7749 21.1768C15.0615 22.4551 14.5514 23.8398 14.2661 25.2803L14.2349 25.3662C14.1543 25.5838 13.8467 25.5837 13.7661 25.3662L12.9204 23.0801L12.7915 23.0322C13.2095 21.7526 13.7877 20.5287 14.5142 19.3906L15.0806 20.9199Z" fill="white"/>
<path d="M12.6113 12.0928L12.6914 12.3086L12.9072 12.3887L14.5586 13L12.9072 13.6113L12.6914 13.6914L12.6113 13.9072L12 15.5586L11.3887 13.9072L11.3086 13.6914L11.0928 13.6113L9.44043 13L11.0928 12.3887L11.3086 12.3086L11.3887 12.0928L12 10.4404L12.6113 12.0928Z" fill="white" stroke="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M19.9812 29.6874C19.25 29.6874 18.6125 29.1687 18.4687 28.4499C18.3187 27.7374 18.7 27.0062 19.375 26.7187L33.1562 20.8124C33.75 20.5687 34.4187 20.6937 34.8625 21.1437C35.3125 21.5874 35.4375 22.2562 35.1875 22.8437L29.2812 36.6249C29.0375 37.1937 28.475 37.5624 27.8562 37.5624C27.7562 37.5624 27.65 37.5562 27.55 37.5312C26.8312 37.3874 26.3125 36.7499 26.3125 36.0124V31.6874V29.6874H24.3125H19.9812ZM26.3062 27.6874H22.1937L32.9 23.0999L28.3062 33.8124V29.6874C28.3062 28.5812 27.4125 27.6874 26.3062 27.6874Z" fill="white"/>
<path d="M23.0775 14.2955L27.078 15.7762C27.4588 15.9172 27.4588 16.4559 27.078 16.5968L23.0775 18.0775L21.5968 22.078C21.4559 22.4588 20.9172 22.4588 20.7762 22.078L19.2955 18.0775L15.295 16.5968C14.9142 16.4559 14.9142 15.9172 15.295 15.7762L19.2955 14.2955L20.7762 10.295C20.9172 9.9142 21.4559 9.9142 21.5968 10.295L23.0775 14.2955Z" fill="white"/>
<path d="M14.6113 21.0928L14.6914 21.3086L14.9072 21.3887L16.5586 22L14.9072 22.6113L14.6914 22.6914L14.6113 22.9072L14 24.5586L13.3887 22.9072L13.3086 22.6914L13.0928 22.6113L11.4404 22L13.0928 21.3887L13.3086 21.3086L13.3887 21.0928L14 19.4404L14.6113 21.0928Z" fill="white" stroke="white"/>
<defs>
<linearGradient id="paint0_linear_314_25697" x1="28" y1="0" x2="28" y2="56" gradientUnits="userSpaceOnUse">
<stop stop-color="#4F6B57"/>
<stop offset="1" stop-color="#213629"/>
</linearGradient>
</defs>
</svg>
    </div>
    <span className="card-title">Looking for help with boats?</span>
    <span className="card-close" onClick={handleCloseCard} aria-label="close proactive message">
  ...
  <button className="card-button" onClick={() => buttonAction({ value: '' })} >Ask Our AI Outfitter</button>
</div>
...
//       </span>
//     </div>
//     <button className="card-button" onClick={() => buttonAction({ value: 'Hi' })}>
//       Ask a Question
//     </button>
//   </div>
// </div> */}

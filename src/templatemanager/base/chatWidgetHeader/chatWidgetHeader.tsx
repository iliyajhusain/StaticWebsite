    ...
    return (
        <div className={hSizeObj[brandingInfo.header.size]} aria-label="chat widget header">
            ...
            <div className="info-content-data">
                ...
                {brandingInfo.header.icon.show && brandingInfo.header.icon.type == 'default' && 
...
<stop offset="1" stop-color="#213629"/>
                ...
                <div className="content-text">
                    ...
                    {/* <h1 className="chat-header-title" aria-label="bot name">Bass Pro 2.0</h1> */}
                    {/* <h2  aria-label="bot desc">{brandingInfo.header.sub_title.name}</h2> */}
                    <h2 aria-label="bot desc">Virtual Boats Assistant</h2>
                </div>
            </div>

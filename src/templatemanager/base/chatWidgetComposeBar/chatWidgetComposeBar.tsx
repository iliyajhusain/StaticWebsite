    ...
    return (
        <div className="chat-widget-composebar" aria-label="chat widget compose">
            ...
            <div className={inputTypeObj[brandingInfo.footer.layout]} aria-label="compose footer">
                ...
                <div className={`compose-text-area ${hostInstance.plugins && hostInstance.plugins['BrowserTTS'] && hostInstance.plugins['BrowserTTS'].name == 'BrowserTTS' && brandingInfo.footer.buttons.emoji.show ? 'emoji-btn-true' : 'only-emoji-btn'}`}>
                    {hostInstance.plugins && hostInstance.plugins['BrowserTTS'] && hostInstance.plugins['BrowserTTS'].name == 'BrowserTTS' &&  <button style={{'display':'none'}} className="speaker-btn speaker-btn-mute show" type="button" aria-label="Mute">
                    ...
                    {hostInstance.plugins && hostInstance.plugins['BrowserTTS'] && hostInstance.plugins['BrowserTTS'].name == 'BrowserTTS' &&  <button style={{'display':'none'}} className="speaker-btn speaker-btn-speak hide" type="button" aria-label="Speak">
                    ...
                    {/* <textarea className="typing-text-area disableComposeBar" 
                    id="typing-text-area" 
                    placeholder={brandingInfo.footer.compose_bar.placeholder}
                    ></textarea> */}
                    <div className="textarea-wrapper">
  <svg className="search-icon" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.35 6.91875C12.35 6.20551 12.2095 5.49925 11.9366 4.8403C11.6636 4.18135 11.2636 3.58261 10.7592 3.07828C10.2549 2.57394 9.65615 2.17388 8.9972 1.90093C8.33825 1.62798 7.63199 1.4875 6.91875 1.4875C6.20551 1.4875 5.49925 1.62798 4.8403 1.90093C4.18135 2.17388 3.58261 2.57394 3.07828 3.07828C2.57394 3.58261 2.17388 4.18135 1.90093 4.8403C1.62798 5.49925 1.4875 6.20551 1.4875 6.91875C1.4875 7.63199 1.62798 8.33825 1.90093 8.9972C2.17388 9.65615 2.57394 10.2549 3.07828 10.7592C3.58261 11.2636 4.18135 11.6636 4.8403 11.9366C5.49925 12.2095 6.20551 12.35 6.91875 12.35C7.63199 12.35 8.33825 12.2095 8.9972 11.9366C9.65615 11.6636 10.2549 11.2636 10.7592 10.7592C11.2636 10.2549 11.6636 9.65615 11.9366 8.9972C12.2095 8.33825 12.35 7.63199 12.35 6.91875ZM11.094 11.7945C9.97383 12.7573 8.51418 13.3375 6.91875 13.3375C3.37301 13.3375 0.5 10.4645 0.5 6.91875C0.5 3.37301 3.37301 0.5 6.91875 0.5C10.4645 0.5 13.3375 3.37301 13.3375 6.91875C13.3375 8.51418 12.7573 9.97383 11.7945 11.094L16.155 15.4575C16.3463 15.6489 16.3463 15.9636 16.155 16.155C15.9636 16.3463 15.6489 16.3463 15.4575 16.155L11.094 11.7945Z" fill="#1E1D19"/>
  </svg>

  <textarea
    className="typing-text-area disableComposeBar"
    id="typing-text-area"
    placeholder={brandingInfo.footer.compose_bar.placeholder}
  ></textarea>
</div>
...
<path d="M12.4217 4.17437C12.1892 3.94187 11.8067 3.94187 11.5742 4.17437L4.97418 10.7744C4.74168 11.0069 4.74168 11.3894 4.97418 11.6219C5.20668 11.8544 5.58918 11.8544 5.82168 11.6219L11.3979 6.04562V20.1981C11.3979 20.5281 11.6679 20.7981 11.9979 20.7981C12.3279 20.7981 12.5979 20.5281 12.5979 20.1981V6.04562L18.1742 11.6219C18.4067 11.8544 18.7892 11.8544 19.0217 11.6219C19.2542 11.3894 19.2542 11.0069 19.0217 10.7744L12.4217 4.17437Z" fill="white"/>
</svg>

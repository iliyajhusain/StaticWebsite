...
export function ChatWidgetComposeBar(props: any) {
    ...
    const container = document.querySelector('kore-chat-window-main-section.retail-assist-theme');
    if (value.trim().length > 0) {
      container?.classList.add('is-textarea-focused');
    } else {
      container?.classList.remove('is-textarea-focused');
    }
  }}
                    ></textarea>
                </div>
